...
<body>
	<div class="header-container">
		...
		<a href="""${pageContext.request.contextPath}/discount">View All Discounts </a><br> <br> 
		<a href="""${pageContext.request.contextPath}/discount">View All Promos </a><br> <br> 
		<a href="FindDiscountById.jsp""${pageContext.request.contextPath}/discount">Find Discount By Id </a><br> <br> 
		<a href="Find""${pageContext.request.contextPath}/discount">Find Promo By Id </a><br> <br> 
		<div></div>
		</j:if>
</body>
</html>